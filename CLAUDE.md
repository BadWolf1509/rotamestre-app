...
- **Número decimal na tela (pt-BR)** — `formatarDecimal` em `src/lib/formatNumber.ts` — nunca `toFixed` cru; **não** troque por `Intl.NumberFormat`, o Hermes pode não ter os dados de locale do ICU e devolve en-US calado
