...
export const RotaOtimizadaBanner = memo(function RotaOtimizadaBanner({
  ...
  return (
    <View
      ...
      accessibilityLabel={`Rota otimizada: ${(rotaOtimizada.distancia_total_metros / 1000).toFixed(1)} quilômetros, ${Math.round(rotaOtimizada.duracao_total_segundos / 60)} minutos`}
    >
