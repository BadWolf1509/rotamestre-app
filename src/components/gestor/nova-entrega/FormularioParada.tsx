    ...
    >
      ...
      {isEditing && onCancelEdit && (
        <TouchableOpacity
          ...
          accessibilityLabel="Cancelar edição da parada"
      ...
      <TouchableOpacity
        ...
        disabled={isLoading}
        accessibilityLabel={
          isEditing ? 'Salvar alterações da parada' : 'Adicionar parada à lista'
        }
        accessibilityRole="button"
      ...
      >
        {isLoading ? (
          ...
          >
            {isEditing ? 'Salvar alterações' : '+ Adicionar Parada'}
          </Text>
        )}
      </TouchableOpacity>
    </View>
