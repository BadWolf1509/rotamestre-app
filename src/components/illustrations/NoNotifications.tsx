...
export const NoNotifications = memo(function NoNotifications({
  ...
  return (
    <View
      ...
      accessibilityLabel="Nenhuma notificacao"
    >
      <View
        style={[
          styles.bgCircle,
      ...
      <View style={styles.bell}>
        <View
          style={[styles.bellTop, { backgroundColor: theme.colors.gray300 }]}
        />
        <View
          style={[styles.bellBody, { backgroundColor: theme.colors.gray300 }]}
        />
        <View
          style={[styles.bellBase, { backgroundColor: theme.colors.gray300 }]}
        />
        <View
          style={[styles.clapper, { backgroundColor: theme.colors.gray400 }]}
        />
      </View>
      <View
        style={[styles.z, styles.z1, { backgroundColor: theme.colors.gray300 }]}
      />
      <View
        style={[
          styles.z,
          styles.z2,
          { backgroundColor: withOpacity(theme.colors.gray300, 0.7) },
        ]}
      />
      <View
        style={[
          styles.z,
          styles.z3,
          { backgroundColor: withOpacity(theme.colors.gray300, 0.4) },
        ]}
      />
    </View>
  );
