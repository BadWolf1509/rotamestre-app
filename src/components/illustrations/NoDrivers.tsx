...
export const NoDrivers = memo(function NoDrivers({
  width = 160,
  height = 140,
}: IllustrationProps) {
  ...
  return (
    <View
      ...
      accessibilityLabel="Nenhum motorista"
    >
      <View
        style={[
          styles.bgCircle,
          { backgroundColor: withOpacity(theme.colors.gray400, 0.08) },
        ]}
      />
      <View style={styles.person}>
        <View
          style={[styles.head, { backgroundColor: theme.colors.gray300 }]}
        />
        <View
          style={[styles.body, { backgroundColor: theme.colors.gray300 }]}
        />
      </View>
      <View style={styles.car}>
        <View
          style={[styles.carBody, { backgroundColor: theme.colors.gray200 }]}
        />
        <View
          style={[styles.wheelL, { backgroundColor: theme.colors.gray400 }]}
        />
        <View
          style={[styles.wheelR, { backgroundColor: theme.colors.gray400 }]}
        />
      </View>
