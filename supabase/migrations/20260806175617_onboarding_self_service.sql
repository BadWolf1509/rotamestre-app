...
BEGIN
  ...
  -- unidades não tem CHECK constraint de faixa: sem esta guarda, uma
  -- coordenada absurda (ex.: latitude 900) entra em silêncio e só falha
  -- depois, na geração de rota, longe da causa. Mesmo padrão de
  -- database/migrations/20260804235500_auditoria_otimizacao_rotas.sql.
  IF p_sede_latitude NOT BETWEEN -90 AND 90
