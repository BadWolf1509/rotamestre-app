...
export class LoginPage {
  ...
  constructor(page: Page) {
    ...
    this.emailInput = page.locator('input[placeholder="E-mail"], input[placeholder="seu@email.com"]');
    this.passwordInput = page.locator('input[placeholder="Senha"], input[placeholder="••••••••"]');
